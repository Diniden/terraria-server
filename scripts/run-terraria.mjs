/**
 * This is a simple script to fire up the correct terraria server as a one time run to help
 * make adminstrative actions a bit easier to handle.
 */
...
child_process.execSync(exe.serverStartScriptPath, {stdio: 'inherit'});
